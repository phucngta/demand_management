...
class planning(models.Model):
    ...
    product_min_qty = fields.Float('Minimum Quantity', readonly=True, compute=_get_stock)
    product_max_qty = fields.Float('Maximum Quantity', readonly=True, compute=_get_stock)
